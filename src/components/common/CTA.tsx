  ...
  return (
    <section className="bg-gray-200 dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center md:py-28 lg:px-12 pt-20">
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Thankyu for Visit   Chef's Recipe</h1>
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          ...
          <Link href="https://github.com/Dharam-IN" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-primary hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-primary dark:hover:bg-gray-700 dark:focus:ring-gray-800">
        ...
        <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
          ...
          <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
            <Link href="https://github.com/Dharam-IN/chefs-recipe" target='_blank' className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
