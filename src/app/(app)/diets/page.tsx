      ...
      <div className="container mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
        <div className="p-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Explore various diets to find the one that fits your lifestyle and
            health goals. From balanced meal plans to specialized diets, we
            provide detailed information to help you make informed choices.
          </p>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4">
              The Mediterranean diet emphasizes fruits, vegetables, whole
              grains, nuts, and seeds. It includes moderate consumption of fish
              and poultry, and limits red meat. Olive oil is the primary source
              of fat.
            </p>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4">
              The ketogenic diet is a high-fat, low-carbohydrate diet that aims
              to induce ketosis, a metabolic state where the body burns fat for
            ...
            <ul className="list-disc list-inside mt-4 text-gray-600 dark:text-gray-400">
              ...
              <li>
                Low carbohydrate intake, primarily from non-starchy vegetables.
              </li>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4">
              A vegan diet excludes all animal products, focusing on plant-based
              foods. It&apos;s rich in fruits, vegetables, whole grains,
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4">
              The Paleo diet, also known as the caveman diet, focuses on foods
              that would have been available to our prehistoric ancestors. It
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4">
              Intermittent fasting involves alternating periods of eating and
              fasting. It&apos;s not about what you eat, but when you eat.
              Common methods include the 16/8 method and the 5:2 diet.
            </p>
            <ul className="list-disc list-inside mt-4 text-gray-600 dark:text-gray-400">
              <li>
              ...
              <li>
                5:2 diet: Eat normally for 5 days and reduce calorie intake for
                2 days.
              </li>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4">
              A gluten-free diet excludes gluten, a protein found in wheat,
              barley, and rye. It&apos;s essential for individuals with celiac
              disease or gluten sensitivity.
            </p>
            <ul className="list-disc list-inside mt-4 text-gray-600 dark:text-gray-400">
              <li>Avoids all foods containing gluten.</li>
              <li>
                Includes naturally gluten-free foods like fruits, vegetables,
                and lean proteins.
              </li>
              <li>
                Can improve digestion and reduce inflammation in sensitive
                individuals.
              </li>
              <li>
                Requires careful label reading to avoid hidden sources of
                gluten.
              </li>
